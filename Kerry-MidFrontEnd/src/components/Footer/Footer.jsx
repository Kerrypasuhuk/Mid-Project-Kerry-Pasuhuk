            ...
            <div className="flex items-center justify-between md:gap-8">
                ...
                <div className="flex item-center gap-4 flex-wrap md:gap-8 mt-10 ">
                    ...
                    <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                        <a href="https://instagram.com/justkerrr_?igshid=OGQ5ZDc2ODk2ZA==" className="text-gray-300 font-[500] text-[18px]">
                            <i class="ri-instagram-line"></i>
                        </a>
                    </span>
                    <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                        <a href="https://www.facebook.com/kerry.pasuhuk.1?mibextid=ZbWKwL" className="text-gray-300 font-[500] text-[18px]">
                            <i class="ri-facebook-fill"></i>
                        </a>
                    </span>
                    <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                        <a href="https://youtube.com/@SUPERTrazz_?si=RCqnD_okuinjOFlv" className="text-gray-300 font-[500] text-[18px]">
                            <i class="ri-youtube-line"></i>
                        </a>
                    </span>
                    <span className="w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center">
                        <a href="https://github.com/Kerrypasuhuk" className="text-gray-300 font-[500] text-[18px]">
